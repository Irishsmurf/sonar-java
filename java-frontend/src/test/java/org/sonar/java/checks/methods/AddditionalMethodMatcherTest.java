...
public class AddditionalMethodMatcherTest {

  @Test
  public void testRawMatching() {
    MethodMatcher anyArg = MethodMatcher.create().typeDefinition(TypeCriteria.subtypeOf("java.lang.Object")).name("match").withNoParameterConstraint();
    MethodMatcher stringOnly = MethodMatcher.create().typeDefinition("org.sonar.test.Test").name("match")
      .addParameter("java.lang.String");
    MethodMatcher stringInt = MethodMatcher.create().typeDefinition("org.sonar.test.Test").name("match")
      .addParameter("java.lang.String").addParameter("int");
    MethodMatcher intInt = MethodMatcher.create().typeDefinition("org.sonar.test.Test").name("match")
      .addParameter("int").addParameter("int");
    MethodMatcher onlyBoolean = MethodMatcher.create().typeDefinition("org.sonar.test.Test").name("match")
      .addParameter("java.lang.Boolean");
  ...
  @Test
  public void constructorRawMatching() {
    MethodMatcher anyArg = MethodMatcher.create().typeDefinition("java.lang.String").name("<init>").withNoParameterConstraint();
    MethodMatcher noArg = MethodMatcher.create().typeDefinition("java.lang.String").name("<init>");
    MethodMatcher stringBuilder = MethodMatcher.create().typeDefinition("java.lang.String").name("<init>")
      .addParameter("java.lang.StringBuilder");
    MethodMatcher stringBytes = MethodMatcher.create().typeDefinition("java.lang.String").name("<init>")
      .addParameter("byte[]").addParameter("int").addParameter("int");
    MethodVisitor visitor = new MethodVisitor();
    visitor.add(anyArg);
    visitor.add(noArg);
  ...
  @Test
  public void testFactoryMatching() {
